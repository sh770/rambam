  ...
  lines.forEach((line) => {
    ...
    if (match) {
      ...
      if (hasCheck || hasV) {
        ...
        if (!users[pendingUser]) users[pendingUser] = { score: 0, messages: 0, checkCount: 0, vCount: 0 };
